...
public class DownloadThread extends Thread{
    ...
    private FileDownloadered filedownloadered;      //文件下载器

    public DownloadThread(FileDownloadered filedownloadered, URL downUrl, File saveFile, int block, int downLength, int threadId) {
        this.downUrl = downUrl;
        this.saveFile = saveFile;
        this.block = block;
        this.filedownloadered = filedownloadered;
